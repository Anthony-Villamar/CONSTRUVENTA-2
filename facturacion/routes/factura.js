...
//       if (rows.length === 0) {
//         return res.status(400).json({ mensaje: `Producto no encontrado: ${producto.codigo_producto}` });
//       }

//       const precioUnitario = parseFloat(rows[0].precio);
//       subtotalProductos += precioUnitario * producto.cantidad;
//     }
